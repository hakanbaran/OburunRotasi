...
class HomeVCTableViewCell: UITableViewCell {
    ...
    public let yemekKategori: UIButton = {
        let button = UIButton()
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        cellView.addSubview(yemekKategori)
    ...
    override func layoutSubviews() {
        ...
        yemekKategori.frame = CGRect(x: width/10+width/4, y: (height-height/1.44-width/20)/2+height/4, width: width/6, height: height/8)
